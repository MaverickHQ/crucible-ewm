...
from ewm_core.transitions import Action, TransitionResult, apply_action
from ewm_core.verifier import VerificationError, VerificationResult, verify_transition
...
def simulate_plan(
    ...
    for step_index, action in enumerate(plan):
        ...
        from ewm_core.explain.explain import explain_transition
